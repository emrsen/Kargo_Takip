...
#define FONA_TX              10   // FONA serial TX pin (pin 3 for shield) Pin10 for MEGA.
...
#define AIO_USERNAME         "Emrsen"  // Adafruit IO username (see http://accounts.adafruit.com/).

#define AIO_KEY              "79a21147bb141e53c452908ccc9d464fd85b13ff"  // Adafruit IO key (see settings page at: https://io.adafruit.com/settings).
